# Credit: https://github.com/nginxinc/docker-nginx/blob/master/stable/stretch/Dockerfile
...
# create nginx user/group first, to be consistent throughout docker variants
    ...
    && apt-get update \
    && apt-get install --no-install-recommends --no-install-suggests -y gnupg1 ca-certificates apt-transport-https \
    && \
